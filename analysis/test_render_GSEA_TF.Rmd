---
title: "Ulceration Figure 2 GSEA"
...
This script performs Gene Set Enrichment Analysis using GO terms and PROGENy to identify pathway activity in ulcerated vs non-ulcerated acral melanoma samples.
...
```{r, fig.width=13, fig.height=10, message=FALSE}
# Data Preparation

# Load ranked gene list 
#ranked_GSEA <- readRDS("DE_results_ulceration_ranked.rds")
#ranked_GSEA <- rownames_to_column(ranked_GSEA, var = "ENSEMBL_GENE_ID")
...
# Save results
#write.csv(progeny_df, "results/PROGENy_pathway_results.csv")
