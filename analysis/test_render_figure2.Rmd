...
This document incorporates differential expression analysis and PCA, in relation to ulceration status in acral melanoma samples. 
It generates visualizations including PCA and volcano plots.
...
# Subset metadata to include only relevant columns for the analysis
...
ranked_GSEA <- as.data.frame(resOrdered) #add gene symbols  
...
# Save 
# saveRDS(significant_genes_final, "DE_results_significant.rds") 
