...
# Figure 1. Clinical characteristics of acral melanoma patients according to ulceration status
...
#ggsave("ulceration_breslow.pdf", height=8, width=7, dpi=400)
...
ggsave("ulceration_mitotic.pdf", height=8, width=8, dpi=400)
...
#ggsave("ulceration_stage.pdf", height=8, width=7, dpi=400)
...
# Save plot
ggsave("ulceration_combined_panel.pdf", final_grid_with_labels, 
       height = 10, width = 12, dpi = 400)
```
